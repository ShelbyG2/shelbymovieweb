...
- [![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fbitfreee%2Fmovie-web-kickstart&env=NEXT_PUBLIC_APP_URL,NEXT_PUBLIC_TMDB_TOKEN,NEXT_PUBLIC_SITE_NAME,NEXT_PUBLIC_TWITTER,NEXT_PUBLIC_INSTAGRAM) 
2. Fill in the required environment variables:
- `NEXT_PUBLIC_APP_URL`: The URL of your deployed project (e.g., `https://shelbymovieweb.vercel.app`)
...
- `NEXT_PUBLIC_SITE_NAME`: The name of your website (e.g., `Shelby Movie Web`)
